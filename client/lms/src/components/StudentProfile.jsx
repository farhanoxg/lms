...
const StudentProfile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const res = await fetch("http://localhost:5000/api/profile/studentprofile", {
          method: "GET",
          headers: {
  ...
  if (!profile) return <div className="text-center text-gray-700">Loading student profile...</div>;
